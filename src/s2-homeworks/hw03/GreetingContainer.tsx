...
export const pureAddUser = (name: string, setError: (error: string) => void, setName: Dispatch<SetStateAction<string>>, addUserCallback: (name: string) => void) => {
...
const GreetingContainer: FC<GreetingContainerPropsType> = ({
    ...
    let lastUserName = totalUsers ? (users.at(-1) as UserType).name : '' // need to fix
